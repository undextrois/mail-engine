<?
$_private_node = "/var/www/_UKML/pub/_UKM880E0D76.110804";

$_k0 = "ABCDEFGHIJKMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz0123456789";

# $_s1 = _encrypt($_s0,$_k0);
# print "$_s1\n";
# $_s1 = _decrypt($_s1,$_k0);
# print "$_s1\n";

$b = array();

$_magic = strtoupper(md5(uniqid(rand(), true)));
# $f = fopen("$_private_node/test.file","r+b");
$f = fopen("test.file","r+b");
while (!feof($f))
{
    # $l = fread($f,42);
    $l = fread($f,24);
...
foreach ($b as $p)
{
  $c = base64_decode(str_rot13(strrev($p)));
  $d = _decrypt($c,$_k0);
  print "$d";
}
