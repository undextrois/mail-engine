...
$tpl->set_file(array("tplHandler"=>"html/contactlist1.htm"));
...
$data = $db->opendb("SELECT * FROM contacts LEFT JOIN contactinfo ON contacts.contactid_PK = contactinfo.contactid_FK 
            ...
            foreach ($data as $info){
		 			   ...
		 			   $icons ='<a href="#" onclick="location.href=(\'EditContact.php?gncontactid_PK='.$info['contactid_PK'].'\')"><img border="0" src="../images/edit1.gif" alt="Edit Contact" width="16" height="16"></a>
