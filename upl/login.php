...
include_once '_HW0NP12/template.inc.php';
include_once '_HW0NP12/common.inc.php';
...
$_gn_tpl->set_var("action-script",$_SERVER['PHP_SELF']);
...
$_gn_tpl->set_var("page-title",$_page_title);
$_gn_tpl->set_var("meta-cache",$_meta_tags);
$_gn_tpl->set_var("_challenge",$_CgCoD);
$_gn_tpl->set_var("_datestamp",$_tStmP);
$_gn_tpl->set_var("_authcode1",$_aCoD);
$_gn_tpl->set_var("_authcode2",$_aCod2);
